const ICON_PATHS = {
  ...
  services: (
    <>
      <path d="M21.5 8.5a3.5 3.5 0 0 0-4.8 4.8L9.5 20.5a1.8 1.8 0 1 0 2 2l7.2-7.2a3.5 3.5 0 0 0 4.8-4.8l-2.4 2.4-1.3-1.3 2.4-2.4a3.5 3.5 0 0 0-.7-.7Z" />
    </>
  ),
}

const ICON_PATHS = {
  ...
  wallet: (
    <>
      <path d="M8 12.5h16v10.5H8v-10.5Z" />
      <path d="M8 16.8h16" />
      <path d="M10.2 14.2h4v2.2h-4v-2.2Z" />
    </>
  ),
  withdraw: (
    <>
      <path d="M9 22h14" />
      <path d="M10.5 22v-6.5h11v6.5" />
      <path d="M16 8.5v8.5" />
      <path d="M13 12 16 8.5 19 12" />
    </>
  ),
  refer: (
    <>
      <circle cx="21.5" cy="10" r="2.5" />
      <circle cx="21.5" cy="22" r="2.5" />
      <circle cx="10.5" cy="16" r="2.5" />
      <path d="M13 15.3 19.1 11" />
      <path d="M13 16.7 19.1 21" />
    </>
  ),
  owed: (
    <>
      <path d="M9.5 11.5c0-2 2.9-3.5 6.5-3.5s6.5 1.5 6.5 3.5-2.9 3.5-6.5 3.5-6.5-1.5-6.5-3.5Z" />
      <path d="M9.5 11.5v4c0 2 2.9 3.5 6.5 3.5s6.5-1.5 6.5-3.5v-4" />
      <path d="M9.5 15.5v4c0 2 2.9 3.5 6.5 3.5s6.5-1.5 6.5-3.5v-4" />
    </>
  ),
}

    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
          ...
          <div>
            <div style={{ fontSize: '15px', fontWeight: '800' }}>Get the PrimaPlug App</div>
            <div style={{ fontSize: '11px', color: '#A09DC8', marginTop: '2px' }}>
              Real-time notifications, live tracking & faster experience
            </div>
          </div>
        </div>
        <div style={{ display: 'flex', gap: '10px' }}>
          <a
            href="https://primaplug.com/app/primaplug.apk"
            download
            style={{
              flex: 1, background: '#6C47FF', color: '#fff',
        ...
        {showIOSSteps && (
          <div style={{
            ...
            <div style={{ fontSize: '12px', fontWeight: '700', color: '#fff', marginBottom: '8px' }}>
              How to install on iPhone (free, no App Store needed):
            </div>
            {[
              '1. Open this page in Safari',
              '2. Tap the Share button at the bottom (⬜↑)',
              '3. Scroll down and tap "Add to Home Screen"',
              '4. Tap "Add" — PrimaPlug will appear on your home screen',
            ].map((step, i) => (
              <div key={i} style={{ fontSize: '12px', color: '#C4C0E8', marginBottom: '5px', lineHeight: '1.5' }}>
                {step}
              </div>
            ))}
            <div style={{ fontSize: '10px', color: '#6F7394', marginTop: '8px' }}>
              Note: must use Safari browser. Chrome on iOS does not support this.
            </div>
          </div>
        )}
        <div style={{ fontSize: '10px', color: '#6F7394', marginTop: '10px', textAlign: 'center' }}>
          Android: tap Download → allow install from unknown sources in settings
        </div>
      </div>
